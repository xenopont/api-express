...
const contentsAsync = async (request: Request, response: Response): Promise<void> => {
...
const contents = (request: Request, response: Response): void => {
    void contentsAsync(request, response)
}
